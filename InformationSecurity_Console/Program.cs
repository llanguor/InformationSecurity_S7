...
using Serilog;
using Utils = InformationSecurity_Tests.Infrastructure.Utils;
...
internal static class Program
{
    ...
    private static void Main()
    {
        ...
        Console.WriteLine(BinaryToString(InitializationVector));
        Console.WriteLine(BinaryToString(value.ToByteArray()));
    }
